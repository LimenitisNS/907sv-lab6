...
import { initialState as todoInitialState, reducer } from '../slices/todoReducer';
import { initialState as alertInitialState } from '../slices/alertReducer';
...
import { selectOptions } from '../slices/todoReducer';
